...
> _"spin up a Forge for your vertical and co-own the model"_ — not _"replace GPT-4."_
...
_(SealedMind, MindVault, Lattice, Mnemos, Synapse, …)_
...
_(Provus, Aegis Vault, VeraSignal, ClawMind, …)_
...
_(AgentHub, SkillMint, AgentMart, zer0Gig, AgentPay, …)_
...
_(ZeroViza, Compass, LocalHero, …)_
...
const llm = new FoundryChat({
  ingotId: "ingot:0x8e2af4a000000000000000000000000000000001",
});
...
> memory; Foundry lets that memory become _equity_. Push your logs into a Forge, own
...
Pitch line: _"Other projects let you use a model. Foundry lets you **own** the model
you helped train — and get paid every time anyone uses it."_
...
- Each integrated team gets a Forge invite → flips them from _users_ to _co-owners_
  (the sticky outcome).
